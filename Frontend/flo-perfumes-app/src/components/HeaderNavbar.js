...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1240px] mx-auto px-4 text-white'>
      <h1 className='w-full text-3xl font-bold text-[#00df9a] p-4'>FP.</h1>
        ...
        {user ? (
          <>
            <div className='relative flex items-center cursor-pointer' onClick={toggleMenu}>
              ...
              {menuOpen && (
                <div className='absolute top-12 right-0 bg-gray-800 p-4 rounded shadow-lg z-50'>
                  <a href='/account' className='block text-white py-1 hover:text-[#00df9a]'>Informații cont</a>
                  <a href='/favorites' className='block text-white py-1 hover:text-[#00df9a]'>Parfumuri preferate</a>
                  <a href='/addPerfume' className='block text-white py-1 hover:text-[#00df9a]'>Adaugă un parfum</a>
                  <a href='/' onClick={handleLogout} className='block text-white py-1 hover:text-[#00df9a]'>Logout</a>
                </div>
              )}
            </div>
          </>
